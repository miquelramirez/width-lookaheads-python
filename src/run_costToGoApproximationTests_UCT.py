...
def run_experiment(Domain, sim_dt, sim_budget, horizon, numberRollouts, N, seeds, seed, includeHeur, includeKuth) :
    ...
    iw_variants = {'Name': ["UCT_random_rollout"]}#, "iw_depth_knuth"]}#, "iw_depth_heur"]}#, "iw_depth_stochastic_enum"]}
    ...
    if includeKuth:
        iw_variants['Name'].append("UCT_knuth")
        iw_parameters.append(iw_depth_knuth_parameters)

    if includeHeur:
        iw_variants['Name'].append("UCT_heur")
